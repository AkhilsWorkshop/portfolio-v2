...
const AboutV2 = () => {
    ...
    return (
        <div
            ...
            className='h-full sm:h-[100dvh] w-full relative overflow-hidden bg-black cursor-none'>
            ...
            <motion.div
                className="absolute hidden md:flex w-5 h-5 border-4 border-[#ABDF12] rounded-full pointer-events-none z-50 mix-blend-exclusion"
                style={{
            ...
            <div className="max-w-screen-lg m-auto flex flex-col items-center justify-center h-full p-10 px-6 border border-white">
