            ...
            <motion.section
                ...
                <motion.div
                    ...
                    <div className="flex flex-col items-start justify-start font-space">
                        ...
                        <motion.h1
                            className="text-3xl md:text-5xl lg:text-6xl font-extrabold leading-tight w-full bg-gradient-to-r from-[#5ce3cc] via-red-400 to-primary bg-clip-text text-transparent uppercase"
                            variants={ITEM_VARIANTS}>
                            Akhil Harikumar
                        </motion.h1>
