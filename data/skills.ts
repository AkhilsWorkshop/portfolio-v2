const aws: String = "https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg"


export const skills: { id: Number, URL: String, title: String, property?: String }[] = [
    {
        id: 22,
